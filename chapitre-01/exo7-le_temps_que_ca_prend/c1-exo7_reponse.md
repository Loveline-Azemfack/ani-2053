...
Par ailleurs. on peut aussi noter que cette differences peut etre due au dependances, car il faut d'abord compiler les projets dont on depend avant d'arriver au projet parent en question. Du coup lorsqu'on a deja compiler pour la premiere fois les projets dont on dependait, et qu'on modifie le projet qu'on est entrain de faire, ca va juste utiliser les projets de dependances deja compiler si on ne les ai pas modifier