## resultat apres jenga info
j'ai tapé jenga info dans mon dossier nkentseu et voici ce que j'obtiens

```
nombre de projet: 273
Parmi ces 273 projets, on a les projet de :
-  type ConsoleApp : 98
- type StaticLib : 60
- type TestSuite : 60
- type WindowedApp : 55
...
Fichier qui sert de racne au demarrage: Nkentseu.jenga
```

### voici le rendu de mon jenga info
